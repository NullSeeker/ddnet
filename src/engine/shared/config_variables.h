...
MACRO_CONFIG_INT(ClTasHud, cl_tas_hud, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Show TAS playback HUD")
...
MACRO_CONFIG_INT(ClTasLoop, cl_tas_loop, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Loop TAS playback at end of file")
